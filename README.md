# В данном групповом проекте, по 12 спринту была добавлена новая функциональность приложению Filmorate. Ниже представлены описания новых API.
...
## - Удаление пользователя и фильма по идентификатору
...
## - Вывод топ-N фильмов по количеству лайков с фильтрацией
...
***
 ...
 ## - Вывод общих фильмов с другом по популярности
...
## - Рекомендации фильмов для просмотра
